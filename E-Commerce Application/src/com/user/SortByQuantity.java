...
public class SortByQuantity {
	...
	public static final String Select_Query="select productid, productname,description, quantity,price from products order by quantity DESC"; 
		
	public void getSortByQuantity() {
